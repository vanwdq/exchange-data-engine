...
public class MatchTest {
    //买单队列
    private static PriorityQueue<Order> buyQueue = new PriorityQueue(new OrderBuyCompartor());
    //卖单队列
    private static PriorityQueue<Order> sellQueue = new PriorityQueue(new OrderSellCompartor());
